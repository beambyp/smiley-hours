...
const MedicalModal: React.FC<ModalProps> = ({ isOpen, onClose, Name, symptom, diagnosis, advice, treatmentDate, treatmentStartTime, treatmentEndTime}) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-[#3074B7] p-8 rounded-lg shadow-lg w-[28rem] relative">
                ...
                <p className="text-white text-xl font-anuphan mb-4 mt-4">{handleRole()}: {Name}</p>
                ...
                <p className="text-white text-xl font-anuphan mb-4 font-bold">วินิจฉัย: </p>
                <p className="text-white text-xl font-anuphan mb-4">{diagnosis}</p>
                <p className="text-white text-xl font-anuphan mb-4 font-bold">คำแแนะนำ: </p>
                <p className="text-white text-xl font-anuphan mb-4">{advice}</p>
            </div>
        </div>
    );
}
