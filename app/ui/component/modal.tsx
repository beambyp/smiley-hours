...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, image, categories, specialization, gender, workplace, licensenumber }) => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-[#3074B7] p-8 rounded-lg shadow-lg w-[28rem] relative">
                ...
                <p className="text-lg text-center text-white mb-4">เลขใบประกอบ {licensenumber}</p>
                ...
                <p className="text-xl text-white mb-4">{specialization}</p>
                <p className="text-xl text-white mb-4">เพศ: {gender}</p>
                <p className="text-xl text-white mb-5">สถานที่ทำงาน: {workplace}</p>
                <button
                    type="submit"
